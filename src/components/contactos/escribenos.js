...
const FloatingButton = () => {
    ...
    return (
        ...
        <Link to="/contactos#form" className={`btn-flotante relative inline-block px-4 py-2 font-medium group${isScrolled ? " btn-flotante-scrolled" : ""}${isScrolled && window.innerHeight + window.scrollY >= document.body.clientHeight ? " btn-flotante-bottom" : ""}`}>
