...
const FloatingButton = () => {
  ...
  return (
    ...
    <a href="#" className={`btn-flotante relative inline-block px-4 py-2 font-medium group${isScrolled ? " btn-flotante-scrolled" : ""}${isScrolled && window.innerHeight + window.scrollY >= document.body.clientHeight ? " btn-flotante-bottom" : ""}`}>
  ...
  <span class="relative text-black group-hover:text-white">Escribenos</span>
</a>
